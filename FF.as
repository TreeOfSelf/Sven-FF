...
dictionary ExplosiveDamges =
{
	...
	{ "monster_handgrenade", 100 }  // NPC hand grenade
};
...
void TrackEntities()
{
	...
	//Grenades are tracked separately as they have a long warmup before throwing after clicking
    AddClassToTrackEntities("grenade", "grenade");
    AddClassToTrackEntities("displacer_portal", "displacer_portal");
	// Add NPC grenade tracking
